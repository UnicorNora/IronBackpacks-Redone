...
public class Player implements IronBackpacksRedonePlayer
{
    ...
    public void sync()
    {
        ...
        {
            this.listeners.forEach(l -> IronBackpacksRedoneNet.sendPlayerDataSync((EntityPlayerMP) this.owner, (EntityPlayerMP) l));
        }
    }
    ...
    public void syncTo(EntityPlayer to)
    {
        if (this.owner instanceof EntityPlayerMP)
        {
            IronBackpacksRedoneNet.sendPlayerDataSync((EntityPlayerMP) this.owner, (EntityPlayerMP) to);
        }
    }

    @Override
    public void copyFrom(IronBackpacksRedonePlayer from)
    {
