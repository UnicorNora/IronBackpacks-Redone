...
import com.unicornora.ironbackpacksredone.item.upgrade.UpgradeNesting;
    ...
    public static class ContainerBackpackInventory extends ContainerBackpack
    {
        ...
        public ContainerBackpackInventory(ItemStack backpack, InventoryPlayer inventoryPlayer, int slotIndex, int slotID)
        {
            ...
            switch (iBackpack.createWrapper().getBackpackType())
            {
                ...
                {
                    offsetY = 50;
                    maxSlots = IronBackpacksRedoneCfg.basicBackpackInventorySize;
                    break;
                }
                ...
                case IRON:
                {
                    rows = 4;
                    offsetY = 84;
                    maxSlots = IronBackpacksRedoneCfg.ironBackpackInventorySize;
                    break;
                }
                ...
                case GOLD:
                {
                    rows = 6;
                    offsetY = 120;
                    maxSlots = IronBackpacksRedoneCfg.goldBackpackInventorySize;
                    break;
                }
                ...
                case DIAMOND:
                {
                    ...
                    offsetX = 44;
                    offsetY = 174;
                    maxSlots = IronBackpacksRedoneCfg.diamondBackpackInventorySize;
                    break;
                }
            }
        ...
        {
            return this.backpackType == EnumBackpackType.DIAMOND ? 13 : 9;
        }
    ...
    public static class ContainerBackpackUpgrades extends ContainerBackpack
    {
        public ContainerBackpackUpgrades(ItemStack backpack, InventoryPlayer inventoryPlayer, int backpackSlot, ContainerBackpack context, int slotID)
        {
            ...
            switch (iBackpack.createWrapper().getBackpackType())
            {
                case BASIC:
                {
                    for (int i = 0; i < IronBackpacksRedoneCfg.basicBackpackUpgradesSize; ++i)
                    {
                ...
                case IRON:
                {
                    for (int i = 0; i < IronBackpacksRedoneCfg.ironBackpackUpgradesSize; ++i)
                    {
                ...
                case GOLD:
                {
                    for (int i = 0; i < Math.min(9, IronBackpacksRedoneCfg.goldBackpackUpgradesSize); ++i)
                    {
                        this.addSlotToContainer(new SlotUpgrade(iBackpack.getUpgrades(), i, 8 + i * 18, 8));
                    }

                    for (int i = 0; i < IronBackpacksRedoneCfg.goldBackpackUpgradesSize - 9; ++i)
                    {
                ...
                case DIAMOND:
                {
                    for (int i = 0; i < IronBackpacksRedoneCfg.diamondBackpackUpgradesSize; ++i)
                    {
