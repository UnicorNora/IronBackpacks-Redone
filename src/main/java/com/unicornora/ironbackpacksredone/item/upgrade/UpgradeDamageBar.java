...
public class UpgradeDamageBar extends ItemSimple implements IUpgrade
{
    ...
    {
        super(IronBackpacksRedoneRegistryNames.itemUpgradeDamageBar, 1);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("ironbackpacksredone.txt.upgrade.damage_bar.desc").split("\\|")));
    }
    ...
    public void onPulse(@Nullable IBackpackWrapper container, IBackpackWrapper backpack, IUpgradeWrapper self, Entity pulsar)
    {
        ...
        backpack.getSelf().getTagCompound().setFloat("ironbackpacksredone:upgrade_damage_bar", val);
    }
    ...
    public void onUninstalled(IBackpackWrapper backpack, IUpgradeWrapper self)
    {
        if (backpack.getSelf().hasTagCompound())
        {
            backpack.getSelf().getTagCompound().removeTag("ironbackpacksredone:upgrade_damage_bar");
        }
    }
