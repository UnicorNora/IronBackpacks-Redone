...
public class UpgradeFilterRegex extends ItemSimple
{
    ...
    {
        super(IronBackpacksRedoneRegistryNames.itemUpgradeFilterRegex, 1);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        if (playerIn instanceof EntityPlayerMP)
        {
            ...
            IronBackpacksRedoneUtils.openContainer((EntityPlayerMP) playerIn, new ContainerFilterRegex(playerIn.inventory, is, slot));
            IronBackpacksRedoneNet.sendOpenGUI(playerIn, handIn == EnumHand.MAIN_HAND ? playerIn.inventory.currentItem : 40, true, slot, EnumGuiType.FILTER_REGEX);
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("ironbackpacksredone.txt.upgrade.filter_regex.desc").split("\\|")));
        for (int i = 0; i < 4; ++i)
        {
