...
public class UpgradeCompressor extends UpgradeFiltered
{
    ...
    {
        super(IronBackpacksRedoneRegistryNames.itemUpgradeCompressor);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("ironbackpacksredone.txt.upgrade.compressor.desc").split("\\|")));
    }
