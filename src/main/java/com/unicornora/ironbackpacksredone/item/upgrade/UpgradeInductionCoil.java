...
public class UpgradeInductionCoil extends ItemSimple implements IUpgrade
{
    ...
    {
        super(IronBackpacksRedoneRegistryNames.itemUpgradeInductionCoil, 1);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("ironbackpacksredone.txt.upgrade.induction_coil.desc").split("\\|")));
    }
