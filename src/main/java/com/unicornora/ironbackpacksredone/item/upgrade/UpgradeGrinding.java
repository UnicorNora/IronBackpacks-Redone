...
public class UpgradeGrinding extends UpgradeFiltered
{
    ...
    {
        super(IronBackpacksRedoneRegistryNames.itemUpgradeGrinding);
    }
    ...
    {
        String[] oreNames = IronBackpacksRedoneUtils.getOreNames(is);
        ...
        for (String name : oreNames)
        {
            ...
            {
                ItemStack stack = IronBackpacksRedoneUtils.firstMatch(i -> !i.isEmpty(), dusts);
                if (stack != null)
                {
                    stack = stack.copy();
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("ironbackpacksredone.txt.upgrade.grinding.desc").split("\\|")));
    }
