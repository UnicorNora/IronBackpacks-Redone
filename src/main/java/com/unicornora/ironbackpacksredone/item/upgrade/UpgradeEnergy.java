...
public class UpgradeEnergy extends ItemSimple implements IUpgrade
{
    ...
    public UpgradeEnergy(String name, int energyAmt)
    {
        ...
        this.isCreative = name.equals(IronBackpacksRedoneRegistryNames.itemUpgradeEnergyCreatve);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("ironbackpacksredone.txt.upgrade.energy." + stack.getItem().getRegistryName().getResourcePath().substring(15) + ".desc").split("\\|")));
    }
