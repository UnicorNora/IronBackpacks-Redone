...
public class UpgradeNesting extends ItemSimple implements IUpgrade
{
    ...
    {
        super(IronBackpacksRedoneRegistryNames.itemUpgradeNesting, 1);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
        ...
        tooltip.addAll(Arrays.asList(I18n.format("ironbackpacksredone.txt.upgrade.nesting.desc").split("\\|")));
    }
