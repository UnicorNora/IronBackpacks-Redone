package com.unicornora.ironbackpacksredone.net;
...
import com.unicornora.ironbackpacksredone.net.message.*;
import com.unicornora.ironbackpacksredone.util.EnumGuiType;

public class IronBackpacksRedoneNet
{
    private static SimpleNetworkWrapper WRAPPER;

    public static void register()
    {
        WRAPPER = NetworkRegistry.INSTANCE.newSimpleChannel(IronBackpacksRedoneRegistryNames.MODID);
    ...
    {
        WRAPPER.sendTo(new SyncPlayerData(of.getEntityId(), IronBackpacksRedonePlayer.of(of).getCurrentBackpack()), to);
    }
